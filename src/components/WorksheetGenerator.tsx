...
export default function WorksheetGenerator({ onBack, studentName = 'مكتشف النور الصغير' }: WorksheetGeneratorProps) {
  // Configuration State
  const [scope, setScope] = useState<'all' | 'unit' | 'lesson'>('all');
